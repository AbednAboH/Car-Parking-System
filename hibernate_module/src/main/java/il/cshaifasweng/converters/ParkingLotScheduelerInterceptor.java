...
public class ParkingLotScheduelerInterceptor implements Interceptor {
        @Override
        public boolean onLoad(Object entity, Serializable id, Object[] state, String[] propertyNames, Type[] types) {
            if (entity instanceof ParkingLotScheduler) {
                ((ParkingLotScheduler) entity).restoreQueueFromList();
                System.out.println("Interceptor is working on ParkingLotScheduler");
                return true;
            }
            return false;
        }
